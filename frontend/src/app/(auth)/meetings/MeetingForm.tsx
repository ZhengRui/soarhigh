...
import type { AgendaSnapshot } from '@/components/ChatPanel';
...
export function MeetingForm({
  ...
  const agendaSnapshot = buildAgendaSnapshot(formData);
  const handleAgendaAfter = (a: AgendaSnapshot) => {
    setFormData((prev) => applyAgendaSnapshot(prev, a, members));
  };
  ...
  return (
    <>
      ...
      <FloatingChatLauncher
        ...
        onAgendaAfter={handleAgendaAfter}
      />
    </>
  );
}
