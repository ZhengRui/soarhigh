...
class MeetingSegment(BaseModel):
    ...
    role_taker: Attendee = Field(description="The attendee/attendees who is/are performing the segment.")
    title: str = Field(
...
class Meeting(BaseModel):
    ...
    meeting_type: str = Field(description="The type of meeting, e.g., Regular, Workshop, Custom.")
    theme: str = Field(description="The theme for the meeting.")
    meeting_manager: Attendee = Field(description="The person organizing/managing the meeting.")
