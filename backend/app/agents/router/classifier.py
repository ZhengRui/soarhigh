...
`direct_answer`, `clarify`) are INTERNAL classification labels. NEVER
mention them in `direct_response` or any text shown to the user. When
describing the system to users, use natural names:
